...
export default function NoSchedule () {
    return (
        <div className="centered-col space-y-6">
            ...
            <button type="button" className="bg-whitesmoke/87 cursor-pointer text-deep normal-space rounded-md">Create schedule</button>
        </div>
    );
}